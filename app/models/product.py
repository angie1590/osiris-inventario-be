...
class Product(Base):
    ...
    stock_minimo: Mapped[Decimal] = mapped_column(Numeric(14, 4), nullable=False, default=0)
    stock_actual: Mapped[Decimal] = mapped_column(Numeric(14, 4), nullable=False, default=0)
    pvp: Mapped[Decimal] = mapped_column(Numeric(14, 4), nullable=False, default=0)
    status: Mapped[ProductStatus] = mapped_column(Enum(ProductStatus), nullable=False, default=ProductStatus.active, index=True)

# Spec: inventory-documents

## Purpose
Gestión de documentos transaccionales de inventario (ingresos, egresos, bajas, ajustes). Incluye validaciones de empresa configurada y soporte de exportación con cabecera corporativa.

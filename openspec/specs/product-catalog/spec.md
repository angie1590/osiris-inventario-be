...
## Purpose
Gestión del catálogo de productos con categorías jerárquicas y atributos personalizados por categoría. Define la estructura base de cada producto y las reglas de herencia de atributos desde categorías padre.

...
## Purpose
Control de acceso basado en roles (RBAC) con tres roles predefinidos: Administrador, Operador y Supervisor. Define los permisos de cada rol y garantiza la verificación de permisos en cada request autenticado.

...
## Purpose
Registro y cálculo del Kardex de inventario por producto, soportando los métodos de valoración PEPS (FIFO) y Promedio Ponderado. Garantiza la reproducibilidad y auditabilidad de todos los cálculos de costo.

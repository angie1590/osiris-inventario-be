# Spec: company-config-ui

## Purpose
Interfaz de usuario para administrar la configuración de empresa. Incluye página de administración con formulario, subida de logo, y navegación desde el sidebar restringida a administradores.
